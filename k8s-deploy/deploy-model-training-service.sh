...
echo ""
echo "查看服务状态:"
echo "  kubectl get pods -n $NAMESPACE -l app=lemo-service-recommender-model-training"
echo ""
echo "查看服务日志:"
echo "  kubectl logs -f -n $NAMESPACE -l app=lemo-service-recommender-model-training"
echo ""
