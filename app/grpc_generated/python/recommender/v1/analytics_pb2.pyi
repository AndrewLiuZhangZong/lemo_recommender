...
class ExportDataResponse(_message.Message):
    ...
    def __init__(self, download_url: _Optional[str] = ..., file_name: _Optional[str] = ..., record_count: _Optional[int] = ..., expires_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
